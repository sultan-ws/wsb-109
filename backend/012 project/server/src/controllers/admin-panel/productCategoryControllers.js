...
const activeProductCategoryByParentCategory = async (req, res)=>{
    try{
        const data = await ProductCategory.find({status: true, deleted_at: null, parent_category: req.params.id});
